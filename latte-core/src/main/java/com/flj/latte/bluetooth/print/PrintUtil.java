...
public class PrintUtil {
    ...
    public static void clearBluetoothState(Context mContext){
        SharedPreferences sharedPreferences = mContext.getSharedPreferences(FILENAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor edit = sharedPreferences.edit();
        edit.remove(DEFAULT_BLUETOOTH_DEVICE_ADDRESS).remove(DEFAULT_BLUETOOTH_DEVICE_NAME).apply();
        AppInfo.btName = null;
        AppInfo.btAddress = null;
    }
    //是否绑定了打印机设备
